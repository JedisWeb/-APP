...
public class MySeek {
    ...
    @Generated(hash = 802812599)
    public MySeek(Long number, @NotNull String telphone, @NotNull String goods,
            String description, @NotNull String seekTime, @NotNull String seekArea,
            @NotNull String address, @NotNull String contacts,
            @NotNull String contactsTel, String questionOne, String answerOne,
            String quesionTwo, String answerTwo, String questionThree,
            String answerThree, String questionFour, String answerFour,
            String questionFive, String answerFive, String pic1, String pic2,
            String pic3, String pic4) {
        this.number = number;
