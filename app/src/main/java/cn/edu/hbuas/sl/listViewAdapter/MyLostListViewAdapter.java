...
public class MyLostListViewAdapter extends ArrayAdapter<MyLostListViewArray> {
     ...
     */
    public MyLostListViewAdapter(Context context, int resource, List<MyLostListViewArray> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        MyLostListViewArray imageListArray = getItem(position); //得到集合中指定位置的一组数据，并且实例化
